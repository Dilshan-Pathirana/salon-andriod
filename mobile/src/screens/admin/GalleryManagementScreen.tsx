...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: COLORS.surface, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: SPACING.xl, maxHeight: '85%', borderTopWidth: 1, borderTopColor: 'rgba(194,173,144,0.2)' },

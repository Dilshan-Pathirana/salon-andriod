...
const styles = StyleSheet.create({
  ...
  avgRating: { fontSize: 36, fontWeight: '700', color: COLORS.text },
  ...
  avatarSmallText: { fontSize: FONTS.sizes.xs, fontWeight: '700', color: COLORS.primary },
  ...
  modalContent: {
    ...
    maxHeight: '80%',
    borderTopWidth: 1,
    borderTopColor: 'rgba(200,162,77,0.2)',
  },
  modalTitle: { fontSize: FONTS.sizes.xl, fontWeight: '700', color: COLORS.text, marginBottom: SPACING.lg },
  modalLabel: { fontSize: FONTS.sizes.sm, fontWeight: '600', color: COLORS.textSecondary, marginTop: SPACING.md, marginBottom: SPACING.sm },
  apptChip: {
    paddingHorizontal: SPACING.md, paddingVertical: SPACING.sm,
    borderRadius: 8, backgroundColor: COLORS.surfaceSecondary,
    borderWidth: 1, borderColor: COLORS.border, marginRight: SPACING.sm,
  },
  apptChipActive: { backgroundColor: COLORS.primary, borderColor: COLORS.primary },
  apptChipText: { fontSize: FONTS.sizes.sm, color: COLORS.textSecondary },
  apptChipTextActive: { color: '#0F0F0F' },
  commentInput: {

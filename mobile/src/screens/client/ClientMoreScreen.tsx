...
const styles = StyleSheet.create({
  ...
  avatar: {
    ...
    backgroundColor: 'rgba(200,162,77,0.1)', justifyContent: 'center', alignItems: 'center',
    borderWidth: 2, borderColor: 'rgba(200,162,77,0.3)',
  },
  avatarText: { fontSize: FONTS.sizes.md, fontWeight: '700', color: COLORS.primary },
